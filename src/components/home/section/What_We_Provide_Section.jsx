...
const items = [
  ...
  // Music School
  {
    ...
    title: "Music School",
    description:
      "We provide music school services to help students learn to play the instrument.",
    link: "/music-school",
    icon: "🎹",
  },
  // Create Song
    ...
    <>
      <div className="mt-12 scroll-animate opacity-0 translate-y-10 transition-all duration-1000">
        <div className="bg-[#111] rounded-3xl border border-[#E6D28C]/10 shadow-[0_0_15px_rgba(230,210,140,0.1)] overflow-hidden">
          ...
          {/* Services Section */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 p-6 md:p-8 font-jetbrains">
            {items.length &&
