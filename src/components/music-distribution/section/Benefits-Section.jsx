          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 max-w-6xl mx-auto">
            {Benefits.length &&
              Benefits.map((benefit, index) => (
                <div
                  key={index}
                  className="group bg-gradient-to-br from-black/90 to-black/70 rounded-lg md:rounded-xl overflow-hidden border border-[#E6D28C]/20 hover:border-[#E6D28C]/50 hover:shadow-[0_0_20px_rgba(230,210,140,0.3)] transition-all duration-300 transform hover:-translate-y-2 p-4 sm:p-5 md:p-6"
                >
                  {/* Icon */}
                  <div className="flex justify-center mb-3 md:mb-4">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-[#E6D28C]/20 to-[#D4AF37]/20 flex items-center justify-center group-hover:from-[#E6D28C]/30 group-hover:to-[#D4AF37]/30 transition-all duration-300 border border-[#E6D28C]/30">
                  ...
                  <div className="text-center">
                    <h3 className="text-base sm:text-lg md:text-xl font-bold text-[#E6D28C] mb-2 sm:mb-3 leading-tight group-hover:text-[#D4AF37] transition-colors duration-300">
                      {benefit.title}
                    </h3>
                    <p className="text-xs sm:text-sm md:text-base text-[#E6D28C]/80 leading-relaxed group-hover:text-[#E6D28C]/90 transition-colors duration-300">
                      {benefit.description}
                    </p>
                  </div>
          ...
          <div className="mt-8 md:mt-12 text-center block sm:hidden">
            <div className="bg-gradient-to-r from-[#E6D28C]/10 to-[#D4AF37]/10 rounded-lg p-4 border border-[#E6D28C]/20">
              <p className="text-sm text-[#E6D28C]/80 leading-relaxed">
                Start your digital music distribution journey today and reach millions of listeners worldwide.
              </p>
            </div>
          </div>
        </div>
