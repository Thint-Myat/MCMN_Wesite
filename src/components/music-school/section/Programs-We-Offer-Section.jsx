              ...
              {courses.length &&
                courses.map((course, index) => (
                  <div
                    ...
                    className="bg-[#1A2151] rounded-3xl p-6 md:p-8 flex flex-col items-center text-center group hover:scale-105 transition-all duration-300 border border-[#E6D28C]/20 hover:border-[#E6D28C]/50 hover:shadow-lg hover:shadow-[#E6D28C]/10 cursor-pointer"
                  >
                    ...
                    {/* Title */}
                    <h1 className="text-white text-xl md:text-2xl mt-3 font-semibold group-hover:text-[#E6D28C] transition-colors duration-300">
                      {course.title}
                    </h1>
                    {/* Lessons */}
