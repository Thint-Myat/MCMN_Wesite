              ...
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
                  ...
                  <div className="flex gap-4 mt-6 justify-center">
                    {selectedInstructor.social?.facebook && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group relative w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-[#E6D28C]/10 to-[#4A90E2]/10 border border-[#E6D28C]/30 hover:border-[#4A90E2] transition-all duration-300 hover:scale-110 hover:-translate-y-1"
                        aria-label="Facebook"
                      >
                        <FaFacebook
                          className="text-[#E6D28C] group-hover:text-[#4A90E2] transition-colors duration-300"
                          size={20}
                        />
                        <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#E6D28C] to-[#4A90E2] opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                      </a>
                  ...
                  {/* <div className="grid grid-cols-2 gap-4 mt-8 w-full max-w-sm">
                    <div className="text-center p-3 rounded-xl bg-gradient-to-br from-[#E6D28C]/10 to-[#4A90E2]/10 border border-[#E6D28C]/20">
                      <div className="text-2xl font-bold text-[#E6D28C]">
                        {selectedInstructor.experience || "8+"}
                      </div>
                      <div className="text-xs text-[#E6D28C]/70">
                        Years Experience
                      </div>
                    </div>
                    <div className="text-center p-3 rounded-xl bg-gradient-to-br from-[#4A90E2]/10 to-[#E6D28C]/10 border border-[#4A90E2]/20">
                      <div className="text-2xl font-bold text-[#4A90E2]">
                        {selectedInstructor.students || "150+"}
                      </div>
                ...
                <div className="lg:w-2/3">
                        ...
                        <div>
                          ...
                          selectedInstructor.classes.length > 0
                            ? selectedInstructor.classes.map((cls, index) => (
                                <div
                                  key={index}
                                  className="group p-5 mb-5 rounded-xl bg-gradient-to-br from-[#0F1629]/80 to-[#1A2151]/80 border border-[#E6D28C]/20 hover:border-[#4A90E2]/40 transition-all duration-300 hover:shadow-[0_0_20px_rgba(74,144,226,0.2)] transform hover:translate-y-[-4px]"
                                ...
                                >
                                  <div className="flex items-start gap-2 mb-3">
                                    ...
                                    <div className="flex-1">
                                      <div className="flex items-center gap-2 text-[#E6D28C] text-2xl font-semibold group-hover:text-[#4A90E2] transition-colors duration-300 mb-1">
                                        {cls.name}
                                        <h4 className="text-[#E6D28C] border border-[#E6D28C]/20 p-1 rounded-full text-xs font-semibold group-hover:text-[#4A90E2] group-hover:border-[#4A90E2]/30 transition-colors duration-300">
                                          {cls.class}
                                        </h4>
                                      </div>
                                    </div>
                                  ...
                                  {selectedInstructor.name === "Phyo Titus" && (
                                    <div className="text-[#E6D28C]/60 text-sm group-hover:text-[#E6D28C]/80 transition-colors duration-300">
                  ...
                  {/* <div className="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-[#E6D28C]/20">
                    <button className="flex-1 group relative px-6 py-4 bg-gradient-to-r from-[#E6D28C] to-[#D4AF37] text-black rounded-xl font-bold transition-all duration-300 hover:shadow-[0_0_30px_rgba(230,210,140,0.4)] transform hover:scale-105 overflow-hidden">
                    ...
                    <button className="flex-1 group relative px-6 py-4 bg-transparent border-2 border-[#4A90E2] text-[#4A90E2] rounded-xl font-bold transition-all duration-300 hover:bg-[#4A90E2] hover:text-white transform hover:scale-105">
