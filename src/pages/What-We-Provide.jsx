...
import Music_School_Section from "../components/what-we-provide/section/Music-School-Section";
    ...
    <>
      <div className="padding pt-[130px] pb-[30px] bg-black text-[#E6D28C]">
        ...
        <div className="flex flex-col lg:flex-row mt-10 gap-8">
          <div className="w-full lg:w-[75%] xl:w-[80%] space-y-8">
